...
//        self.shapeLayer = shapeLayer;
        self.backgroundColor = [UIColor colorWithRed:242.0/255.0 green:165.0/255.0 blue:31.0/255.0 alpha:1.0];
        ...
        self.textLabel.layer.borderColor = [UIColor darkGrayColor].CGColor;
...
//    self.shapeLayer.path = [UIBezierPath bezierPathWithRect:CGRectMake(2, 2, self.frame.size.width-4, self.frame.size.width-4)].CGPath;
}
